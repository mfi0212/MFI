...
function computeLoanStatus(loan) {
  ...
  if (diff > 0) {
    ...
    // Still time left
    status = 'Active';
    daysInfo = Math.abs(diff) + ' day(s) left';
  }
...
const users = {
  "Mahesh Muthinti": {
    ...
    loans: [
      { amount: 2000, interest: 990,  borrowed: "28-07-2026", return: "28-08-2026", overdueFee: 25 },
      { amount: 960,  interest: 120,  borrowed: "15-08-2026", return: "30-08-2026", overdueFee: 0 },
