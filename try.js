...
function displayLoanDetails(loan, index) {
    ...
    padding-top: 30px;position: sticky;
    top: 230px;opacity: 100%;
    z-index: 100000;">
                <div class="leftflow">
<h3>Purpose</h3>
                </div>
                <input type="text" class="purpose-input" placeholder="Enter here..." value="${loan.purpose || ''}" onchange="updatePurpose(${index}, this.value)">
            </div>
            <div class="details">
                <div class="leftflow">
