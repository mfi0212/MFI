...
<svg xmlns="http://www.w3.org/2000/svg" id="Layer_2" data-name="Layer 1" viewBox="0 0 24 24">
  <path d="m24,2v4c0,.553-.447,1-1,1s-1-.447-1-1v-2.586l-3.293,3.293c-.195.195-.451.293-.707.293s-.512-.098-.707-.293c-.391-.391-.391-1.023,0-1.414l3.293-3.293h-2.586c-.553,0-1-.447-1-1s.447-1,1-1h4c1.103,0,2,.897,2,2Zm-3.398,5.641c.888,1.587,1.398,3.412,1.398,5.359,0,6.075-4.925,11-11,11S0,19.075,0,13,4.925,2,11,2c1.947,0,3.773.511,5.359,1.398l-.481.481c-1.17,1.17-1.17,3.072,0,4.242.566.566,1.32.879,2.121.879s1.555-.312,2.121-.879l.481-.481Zm-5.602,7.359c0-1.359-.974-2.51-2.315-2.733l-3.04-.506c-.374-.062-.645-.382-.645-.761,0-.552.448-1,1-1h2.268c.356,0,.688.191.867.501.275.478.886.643,1.366.364.478-.276.642-.888.364-1.366-.534-.925-1.53-1.499-2.598-1.499h-.268v-1c0-.553-.447-1-1-1s-1,.447-1,1v1c-1.654,0-3,1.346-3,3,0,1.359.974,2.51,2.315,2.733l3.04.506c.374.062.645.382.645.761,0,.552-.448,1-1,1h-2.268c-.356,0-.688-.191-.867-.501-.275-.479-.887-.645-1.366-.364-.478.276-.642.888-.364,1.366.534.925,1.53,1.499,2.598,1.499h.268v1c0,.553.447,1,1,1s1-.447,1-1v-1c1.654,0,3-1.346,3-3Z"/>
</svg>
<h3>Taken From</h3>
                </div>
                <p>${loan.takenFrom}</p>
...
<svg xmlns="http://www.w3.org/2000/svg" id="Layer_5" data-name="Layer 1" viewBox="0 0 24 24" width="512" height="512"><path d="M10,22.5c0,.829-.671,1.5-1.5,1.5h-3c-3.033,0-5.5-2.467-5.5-5.5V7.5C0,4.467,2.467,2,5.5,2h.5v-.5c0-.829,.671-1.5,1.5-1.5s1.5,.671,1.5,1.5v.5h6v-.5c0-.829,.672-1.5,1.5-1.5s1.5,.671,1.5,1.5v.5h.5c3.032,0,5.5,2.467,5.5,5.5,0,.829-.672,1.5-1.5,1.5H3v9.5c0,1.378,1.122,2.5,2.5,2.5h3c.829,0,1.5,.671,1.5,1.5Zm14-5c0,3.59-2.91,6.5-6.5,6.5s-6.5-2.91-6.5-6.5,2.91-6.5,6.5-6.5,6.5,2.91,6.5,6.5Zm-4.156,.223l-.844-.844v-1.379c0-.828-.672-1.5-1.5-1.5s-1.5,.672-1.5,1.5v1.793c0,.53,.211,1.039,.586,1.414l1.137,1.137c.586,.586,1.535,.586,2.121,0,.586-.586,.586-1.535,0-2.121Z"/></svg>
            ...
            <div class="details">
                <div class="leftflow">
<svg xmlns="http://www.w3.org/2000/svg" id="Layer_7" data-name="Layer 1" viewBox="0 0 24 24">
